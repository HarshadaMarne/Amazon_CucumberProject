...
public class TestDataReader {
    //C:\Users\HMARNE\Documents\TestLeafData.xlsx
    ...
    public static void init(){
        ...
        try {
            fileInputStream = new FileInputStream("src/test/resources/AmazonData.xlsx");
        ...
        for (int i = 1; i <= sheet.getLastRowNum(); i++) {
            ...
            if(row != null && row.getCell(0)!=null) {
                ...
                System.out.println(data.put(key, rowData));
            }
        }
